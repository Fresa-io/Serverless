...
def test_aws_credentials():
    ...
    print(f"AWS_ACCESS_KEY_ID environment variable: {'Set' if os.environ.get('AWS_ACCESS_KEY_ID') else 'Not set'}")
    print(f"AWS_SECRET_ACCESS_KEY environment variable: {'Set' if os.environ.get('AWS_SECRET_ACCESS_KEY') else 'Not set'}")
    print()
