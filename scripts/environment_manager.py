...
class EnvironmentManager:
    ...
    def get_alias_environment_variables(self, function_name: str, alias_name: str) -> Dict[str, str]:
        ...
        try:
            ...
            print(f"❌ Error getting environment variables for {function_name}:{alias_name}: {e}")
            return {}
    ...
    def update_alias_environment_variables(
        ...
        try:
            ...
            print(f"❌ Error updating environment variables for {function_name}:{alias_name}: {e}")
            return False

    def setup_environment_specific_variables(self, function_name: str, environment: str) -> bool:
    ...
    def list_all_environment_variables(self) -> Dict[str, Dict[str, str]]:
        ...
        for function_key, function_name in self.functions.items():
            ...
            for env_name, env_config in self.environments.items():
                ...
                alias_env_vars = self.get_alias_environment_variables(function_name, alias_name)
                if alias_env_vars:
    ...
    def sync_environment_variables(self, function_name: str) -> bool:
        ...
        for env_name, env_config in self.environments.items():
            ...
            if not self.update_alias_environment_variables(function_name, alias_name, env_vars):
                success = False
