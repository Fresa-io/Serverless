...
class TestCreateauthchallenge(unittest.TestCase):
    ...
    def test_createAuthChallenge_success(self):
        ...
        result = createAuthChallenge.createAuthChallenge(self.test_event, self.test_context)
    ...
    def test_createAuthChallenge_invalid_event(self):
        ...
        invalid_event = {}
        result = createAuthChallenge.createAuthChallenge(invalid_event, self.test_context)
