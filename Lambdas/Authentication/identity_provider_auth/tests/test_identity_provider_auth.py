...
class TestIdentityproviderauth(unittest.TestCase):
    ...
    def test_identity_provider_auth_success(self):
        ...
        result = identity_provider_auth.identity_provider_auth(self.test_event, self.test_context)
    ...
    def test_identity_provider_auth_invalid_event(self):
        ...
        invalid_event = {}
        result = identity_provider_auth.identity_provider_auth(invalid_event, self.test_context)
