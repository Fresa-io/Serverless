...
class TestVeriftauthchallenge(unittest.TestCase):
    ...
    def test_veriftAuthChallenge_success(self):
        ...
        result = veriftAuthChallenge.veriftAuthChallenge(self.test_event, self.test_context)
    ...
    def test_veriftAuthChallenge_invalid_event(self):
        ...
        invalid_event = {}
        result = veriftAuthChallenge.veriftAuthChallenge(invalid_event, self.test_context)
