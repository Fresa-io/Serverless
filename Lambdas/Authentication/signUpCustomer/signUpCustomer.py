...
def validate_verification_code(email, user_code):
    ...
    try:
        ...
        if current_time > expiration_time:
            print(f"Code expired for {email}. Current: {current_time}, Expiration: {expiration_time}")
...
def send_welcome_email(email, first_name, gender):
    ...
    try:
        ...
        print(f"Welcome email sent successfully to {email}. MessageId: {response['MessageId']}")
        return True
